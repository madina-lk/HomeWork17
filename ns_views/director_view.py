...
class DirectorView(Resource):
    ...
    def get(self):
        ...
        """
        return get_all_records(Director, director_schema)

    def post(self):
        """
         Создание новой записи
        """
        return insert_record(Director)
...
class DirectorView(Resource):
    ...
    def get(self, director_id: int):
        ...
        """
        try:
            return get_record_by_pk(Director, director_schema, director_id)
    ...
    def put(self, director_id: int):
        ...
        """
        return update_record(Director, director_id)

    def delete(self, director_id: int):
        """
        Удаление сущности по ID
        """
        return delete_record(Director, director_id)